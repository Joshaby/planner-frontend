...
interface InviteGuestsModalProps {
  ...
  addEmailToInvite: (form: FormEvent<HTMLFormElement>) => void;
  removeEmailFromInvite: (email: string) => void;
}

export const InviteGuestsModal = ({ closeGuestsModal, emailsToInvite, addEmailToInvite, removeEmailFromInvite }: InviteGuestsModalProps) => {
  return (
